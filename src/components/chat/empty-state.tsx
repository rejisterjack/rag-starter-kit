...
import { Sparkles, Upload, MessageSquare, FileText, Zap } from "lucide-react";
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Upload documents and ask questions. I&apos;ll find the answers from your
            knowledge base.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground">
            Supports PDF, Word, TXT, and more
          </p>
