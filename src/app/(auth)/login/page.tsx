...
export default function LoginPage(): React.ReactElement {
  ...
  // Show SSO-only login if forceSSO is enabled
  ...
  return (
    <div className="space-y-6">
      ...
      {/* SSO Warning when forceSSO is enabled */}
      {showSSOOnly && (
      ...
      {/* OAuth Buttons - Hidden when SSO is forced */}
      {!showSSOOnly && (
      ...
      {/* SSO Button - Show when domain detected or as primary option when forced */}
      ...
      {/* Email/Password Form - Hidden when SSO is forced */}
      {!showSSOOnly && (
        <>
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
...
// =============================================================================
// SSOLoginButton Component (Inline for this file)
// =============================================================================
...
function SSOLoginButton({
  ...
  const handleClick = () => {
    if (ssoMethods.length === 1) {
      onSSOSelected(ssoMethods[0], ssoMethods[0].id);
    }
  };
