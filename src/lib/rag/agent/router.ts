...
const fewShotExamples: FewShotExample[] = [
  {
    ...
    classification: {
      ...
      confidence: 0.95,
      reasoning: "This is a simple factual question that can be answered directly without document retrieval.",
    },
  },
  {
    ...
    classification: {
      ...
      confidence: 0.98,
      reasoning: "This query explicitly asks about content from a specific document (financial report).",
  ...
  },
  {
    ...
    classification: {
      ...
      confidence: 0.85,
      reasoning: "This query is vague and refers to unspecified previous context. Need clarification.",
    },
  },
  {
    ...
    classification: {
      type: QueryType.RETRIEVE,
      confidence: 0.88,
      reasoning: "This requires retrieving information from uploaded documents and comparing values.",
  ...
  },
  {
    ...
    classification: {
      type: QueryType.RETRIEVE,
      confidence: 0.94,
      reasoning: "This requires both document retrieval (to find the budget) and calculation (25%).",
      suggestedTools: ['document_search', 'calculator'],
    },
  },
];
...
export class QueryRouter {
  ...
  async shouldUseRAG(
    ...
    return classification.type === QueryType.RETRIEVE || 
           classification.type === QueryType.CALCULATE;
  }
...
- suggestedTools: Array of recommended tools (optional)`;
  ...
  private heuristicClassification(content: string): QueryClassification {
    ...
    if (lower.includes('direct_answer')) {
      return { type: QueryType.DIRECT_ANSWER, confidence: 0.7, reasoning: 'Heuristic classification' };
    }
